...
execute store result score @e[tag=onigokko_marker] kaonasi_onigokko_setting_role_count run tag @a[tag=kaonasi_oni_roulette,predicate=saladbowl_server_oni:do_not_have_roles,limit=1,sort=random] add kaonasi_roles_oni
