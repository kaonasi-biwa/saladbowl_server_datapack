...
tellraw @s [{"text":"タスク数の設定"},{"text":"[開く]","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/function saladbowl_server_oni:setting/role_setting/"}}]

tellraw @s [{"text":"\nゲームのスタート"},{"text":"[開く]","color":"blue","bold":true,"clickEvent":{"action":"run_command","value":"/amongustask tasksetting"}}]
tellraw @s {"text":"---------------------"}