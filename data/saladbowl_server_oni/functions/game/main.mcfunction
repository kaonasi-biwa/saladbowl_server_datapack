...
execute if entity @a[scores={kaonasi_onigokko_setting_start_time_game=0}] if score @e[tag=onigokko_marker,limit=1] kaonasi_onigokko_setting_map matches 1 run tell @a[scores={kaonasi_onigokko_setting_start_time_game=0},tag=kaonasi_roles_spectator] aaa
