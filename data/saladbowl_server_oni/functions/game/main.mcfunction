...
execute if score @e[tag=onigokko_marker,limit=1] kaonasi_onigokko__tick_display = @e[tag=onigokko_marker,limit=1] kaonasi_onigokko_the_skeld__escape_start run fill -186 -59 154 -182 -59 158 diamond_block
