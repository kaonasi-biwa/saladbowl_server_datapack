...
execute unless entity @e[tag=saladbowl_server_oni,scores={kaonasi_onigokko_setting=1..}] run scoreboard players set @e[tag=saladbowl_server_oni] kaonasi_onigokko_setting 1